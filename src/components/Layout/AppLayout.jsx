...
function AppLayout(props: Props) {
  ...
  return (
    <Box sx={{ display: 'flex' }}>
        ...
        <Toolbar>
          ...
          <Box sx={{ display: { xs: 'none', sm: 'block' } }}>
            ...
            <Badge badgeContent={count} color="secondary">
              <ShoppingCartIcon sx={{ cursor: 'pointer' }} className="text-white" onClick={toggleCartList(true)} />
            </Badge>
      ...
      <CartList openCartList={openCartList} toggleCartList={toggleCartList} /> {/* Fixed typo here */}
    </Box>
  );
}
